...
router.get('/', [validateJWT, isMetaUserAdmin, validateFields], adminsGet)

router.get('/:id', [validateJWT, isMetaUserAdmin, validateFields], adminsGet)
router.get('/:id/subAdmins', [validateJWT, isMetaUserAdmin, validateFields], adminsGet)
